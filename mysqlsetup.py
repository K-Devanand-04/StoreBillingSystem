...
def MysqlSetup():
    try:
      ...
      PRIMARY KEY (customerid)
        ...
        Label(SqlSetupStartWindow, text="MySQL Password: ", font=Font5, bg=LoginPageTheme1,fg=TreeviewHeadingBackground1).place(x=5, y=20)
        ...
        ChangeButton = Button(SqlSetupStartWindow, text="Enter", font=Font5, bg=LoginPageTheme1,
                              ...
                              fg=LoginPageTheme2, activeforeground=LoginPageTheme2, relief=RIDGE, bd=2,command=lambda: (SetSqlPassword(NewUsername.get()), SqlSetupStartWindow.destroy(), MysqlSetup()))
