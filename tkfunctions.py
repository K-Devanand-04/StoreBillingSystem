...
def BillingFrameWidgets(window_name):
    ...
    BillTree.place(relheight=1, relwidth=0.98, relx=0.01)
    # ========================================================================== #
...
def ActivityFrameWidgets(window_name):
    ...
    ReturnBtn = Button(ButtonHoldFrame, text="Return To Billing Page", font=Font4, bg=ActivityLogFrameTheme,
                       relief=SOLID, command=lambda: FrameRaise(BillingFrame))
...
def InventoryFrameWidgets(window_name, AddItemHolder=None):
    ...
    ReturnBtn = Button(ButtonHoldFrame, text="Return To Billing Page", font=Font4, bg=LoginPageTheme1, relief=SOLID,
    ...
    GetSelectionIntoEntryButton = Button(UpdateAndDeleteHolder, text="Get Selection", font=Font7,
                                         bg=TreeviewBackgroundTheme1, activebackground=TreeviewBackgroundTheme1,
                                         relief=SOLID,
